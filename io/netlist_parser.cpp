...
public:
    ...
    static NetlistElementType parseElementType(const std::string& type_str) {
        if (type_str == "R" || type_str == "res") return NetlistElementType::Resistor;
        if (type_str == "C" || type_str == "cap") return NetlistElementType::Capacitor;
        if (type_str == "L" || type_str == "ind") return NetlistElementType::Inductor;
        if (type_str == "V" || type_str == "vsrc") return NetlistElementType::VoltageSource;
        if (type_str == "I" || type_str == "isrc") return NetlistElementType::CurrentSource;
        if (type_str == "M" || type_str == "mos") return NetlistElementType::MOSFET;
        if (type_str == "Q" || type_str == "bjt") return NetlistElementType::BJT;
        if (type_str == "D" || type_str == "diode") return NetlistElementType::Diode;
        if (type_str == "X") return NetlistElementType::Instance;
...
std::string NetlistParser::toNetlist() const {
    ...
    for (const auto& elem : pImpl->elements_) {
        switch (elem.type) {
            case NetlistElementType::Resistor: oss << "R"; break;
            case NetlistElementType::Capacitor: oss << "C"; break;
            case NetlistElementType::Inductor: oss << "L"; break;
            case NetlistElementType::VoltageSource: oss << "V"; break;
            case NetlistElementType::CurrentSource: oss << "I"; break;
            case NetlistElementType::MOSFET: oss << "M"; break;
            case NetlistElementType::BJT: oss << "Q"; break;
            case NetlistElementType::Diode: oss << "D"; break;
            default: oss << "X"; break;
        }
